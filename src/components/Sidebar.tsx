...
import { X, Home, Users, Grid3x3, BarChart3, Radio, Store, HelpCircle, Info, Globe, LogOut } from "lucide-react";
    ...
    <>
      ...
      >
        ...
        <div className="relative overflow-hidden bg-[linear-gradient(140deg,var(--maroon-800),var(--maroon-950))] px-4 pb-5 pt-4">
          ...
          />
          {/* corner flourish — quiet diamond motif, top-left */}
          <div
            aria-hidden="true"
            className="pointer-events-none absolute -left-3 -top-3 h-16 w-16 rotate-45 border border-[var(--gold-500)]/15"
          />
